...
import res.frontend.BevelArrows.Arrow;

/**
 *
 * @author Hood
 */
public class Graphics2DWithArrow extends Graphics2D {
    Graphics2D g2d;
    static Arrow noArrow = new BevelArrows.NoArrow();
    Arrow arrowHead;
    
    Graphics2DWithArrow(Graphics2D g2d){
        this.g2d = g2d;
        arrowHead = noArrow;
    }
    
    public void drawArrow(double x1, double y1, double x2, double y2){
        arrowHead.draw(this,x1,y1,x2,y2);
    }
    ...
    // Okay, now we have a bajillion passthrough methods
